...
def test_blocks_with_page_type_are_ignored(block_with_content, another_block_with_content):
    another_block_with_content.data['value']['type'] = 'page'

    block_list = NotionBlockList([block_with_content, another_block_with_content])

    assert block_list.get_underlying_block_ids() == {'a', 'b', 'c'}, 'another_block_with_content should be ignored'
