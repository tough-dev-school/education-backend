...
def element(element_fields):
    return AmoCRMCatalogElement(id=14229449, name="PopugFields", custom_fields_values=element_fields)
...
@pytest.mark.usefixtures("_successful_response")
def test_update_catalog_element_patch_correct_params(user, amocrm_client, patch, element):
    amocrm_client.update_catalog_element(catalog_id=777, element=element)
