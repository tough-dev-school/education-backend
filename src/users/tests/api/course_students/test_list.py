...
def test_response_with_study_course_is_ok(as_superuser, study):
...
def test_response_with_course_without_students_is_ok(as_superuser, course):
...
def test_response_students_ordered_by_first_name(as_superuser, course, factory):
