...
def bob_a(mixer) -> User:
    return mixer.blend(
        ...
        date_joined=datetime(2021, 11, 1, tzinfo=timezone.utc),
    )
...
def bob_b(mixer) -> User:
    return mixer.blend(
        ...
        username='Bob@Example.Com',
        email='Bob@Example.Com',
        date_joined=datetime(2021, 11, 2, tzinfo=timezone.utc),
    )
...
def bob_c(mixer) -> User:
    return mixer.blend(
        ...
        username='BOB@EXAMPLE.COM',
        email='BOB@EXAMPLE.COM',
        date_joined=datetime(2021, 11, 3, tzinfo=timezone.utc),
    )
