# Generated by Django 4.1.9 on 2023-06-21 06:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name="reaction",
            constraint=models.UniqueConstraint(fields=("author", "answer", "emoji"), name="Only one unique emoji per answer from one author"),
        ),
    ]
