...
def another_order(factory, user):
    return factory.order(user=user, paid="2032-12-01 15:20+03:00")


@pytest.mark.usefixtures("another_order")
def test_not_sending_with_another_order(trigger, freezer):
    freezer.move_to("2032-12-02 16:00+03:00")

    assert trigger.should_be_sent() is False


@pytest.mark.parametrize(
    "change_another_order",
    [
        lambda another_order: another_order.setattr_and_save("created", "2031-01-01 15:30+03:00"),  # more then a year ago
