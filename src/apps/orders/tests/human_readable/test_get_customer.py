...
def test_include_first_name_last_name_if_name_and_email_are_short_enough(order) -> None:
    got = human_readable.get_order_customer(order)

    assert got == 'Иван Хрюнов &lt;<a href="mailto:khrunov@gmail.com">khrunov@gmail.com</a>&gt;'


def test_exclude_last_name_from_template_if_name_and_email_is_middle_sized(order) -> None:
...
def test_contains_email_only_if_name_and_email_is_to_long(order) -> None:
