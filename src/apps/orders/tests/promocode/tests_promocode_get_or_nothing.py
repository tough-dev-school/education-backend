...
def test_found(ten_percent_promocode, name) -> None:
...
def test_not_found_when_promo_code_is_disabled(ten_percent_promocode) -> None:
...
def test_not_found_when_promo_code_has_expired(ten_percent_promocode, expires, is_found) -> None:
