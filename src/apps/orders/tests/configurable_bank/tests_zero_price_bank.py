...
def test_zero_price_bank(call_purchase) -> None:
...
def test_fails_with_non_zero_priced_courses(call_purchase, course) -> None:
...
def test_fails_without_redirect_url(call_purchase) -> None:
