...
def test_image_not_rewritten(image) -> None:
...
def test_page_rewritten(page) -> None:
...
@pytest.mark.usefixtures("asset")
def test_https_rewrite(image, mocker) -> None:
