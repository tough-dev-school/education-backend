...
def test_call_update_cache(mock_fetch_page_recursively, mock_cache_set, material, page) -> None:
...
def test_call_update_cache_for_all_pages(mock_fetch_page_recursively, mock_cache_set, material, page, mixer) -> None:
    for _ in range(3):
