...
def test_request_reset_password_send_email_with_args(anon, send_mail) -> None:
    data = {
...
def test_send_nothing_if_user_not_exists(anon, send_mail) -> None:
    data = {
...
def test_uses_password_reset_form_template_id_settings(user, anon, settings, send_mail) -> None:
