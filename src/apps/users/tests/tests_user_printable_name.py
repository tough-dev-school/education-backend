...
def test_russian(mixer, first_name, last_name, expected) -> None:
...
def test_language_spelling_is_case_insensitive(mixer, language) -> None:
...
def test_english(mixer, first_name_en, last_name_en, expected) -> None:
