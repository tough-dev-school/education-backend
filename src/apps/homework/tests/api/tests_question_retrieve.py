...
def test_markdown(api, question) -> None:
...
def test_403_for_not_purchased_users(api, question, purchase) -> None:
    purchase.refund()

    api.get(f"/api/v2/homework/questions/{question.slug}/", expected_status_code=403)


def test_ok_for_superusers_even_when_they_did_not_purchase_the_course(api, question, purchase) -> None:
    purchase.refund()
...
def test_ok_for_users_with_permission_even_when_they_did_not_purchase_the_course(api, question, purchase) -> None:
    purchase.refund()
...
def test_ok_if_user_has_not_purchased_but_permission_check_is_disabled(api, settings, question, purchase) -> None:
