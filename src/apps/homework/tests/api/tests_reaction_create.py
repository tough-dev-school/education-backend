...
def test_creation(api, url, answer, emoji) -> None:
...
def test_create_reaction_fields(api, url, emoji, answer) -> None:
...
def test_create_fails_if_not_a_single_emoji(api, url, emoji) -> None:
...
def test_create_fails_if_not_a_valid_slug(api, url, emoji, bad_slug) -> None:
