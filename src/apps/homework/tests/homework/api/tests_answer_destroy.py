...
def test_marks_crosscheck_as_unchecked(api, answer, child_answer_of_same_user, mixer):
    crosscheck = mixer.blend("homework.AnswerCrossCheck", answer=answer, checker=api.user, checked=datetime(2032, 1, 1, 12, 30, tzinfo=timezone.utc))
...
def test_doesnt_mark_crosscheck_as_checked_for_another_answer(api, child_answer_of_same_user, mixer):
    crosscheck = mixer.blend("homework.AnswerCrossCheck", checker=api.user, checked=datetime(2032, 1, 1, 12, 30, tzinfo=timezone.utc))
...
def test_doesnt_mark_crosscheck_as_checked_for_another_checker(api, answer, child_answer_of_same_user, mixer):
    crosscheck = mixer.blend("homework.AnswerCrossCheck", answer=answer, checked=datetime(2032, 1, 1, 12, 30, tzinfo=timezone.utc))
