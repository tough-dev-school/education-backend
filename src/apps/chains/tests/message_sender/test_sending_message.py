...
def test_message_is_sent(send_message, message, study, owl) -> None:
    send_message()
...
def test_message_is_sent_only_once(send_message, owl) -> None:
    send_message()
    send_message()
...
def test_message_is_not_sent_when_progress_record_exists(send_message, message, study, owl, success) -> None:
...
def test_progress_is_saved(send_message, message, study) -> None:
    send_message()
...
def test_progress_status_is_saved_when_message_is_not_sent(send_message, message, study, owl, exc) -> None:
