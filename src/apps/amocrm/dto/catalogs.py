...
class AmoCRMCatalogsDTO:  # NOQA: PIE798
    @staticmethod
    def get() -> list[amo_types.Catalog]:
        """
    ...
    @staticmethod
    def get_fields(catalog_id: int) -> list[amo_types.CatalogField]:
        """
    ...
    @staticmethod
    def get_contacts_fields() -> list[amo_types.CatalogField]:
        """
