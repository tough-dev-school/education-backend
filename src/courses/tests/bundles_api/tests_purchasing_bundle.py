...
def test_order(client, bundle):
    client.post('/api/v2/bundles/pinetree-tickets/purchase/', {
        'name': 'Забой Шахтёров',
...
def test_redirect(client, bundle):
...
def test_custom_success_url(client, bundle, bank):
    client.post('/api/v2/bundles/pinetree-tickets/purchase/', {
        'name': 'Забой Шахтёров',
        'email': 'zaboy@gmail.com',
        'price': 1900,
