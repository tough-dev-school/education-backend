...
def subscribe_user(mocker):
    return mocker.patch("core.integrations.dashamail.client.AppDashamail.subscribe_user")


@pytest.fixture
def get_subscriber_doesnt_exist(mocker):
    return mocker.patch("core.integrations.dashamail.client.AppDashamail.get_subscriber", return_value=(None, False))


@pytest.fixture
def get_subscriber_active(mocker):
    return mocker.patch("core.integrations.dashamail.client.AppDashamail.get_subscriber", return_value=(1337, True))


@pytest.fixture
def get_subscriber_inactive(mocker):
    return mocker.patch("core.integrations.dashamail.client.AppDashamail.get_subscriber", return_value=(1337, False))


@pytest.fixture
def update_subscriber(mocker):
    return mocker.patch("core.integrations.dashamail.client.AppDashamail.update_subscriber")
