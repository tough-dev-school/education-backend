...
def test_image_is_rewritten_if_not_in_asset_cache(image):
    assert rewrite(image)["properties"]["source"] == [["https://notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2Fd95897d2-8698-468b-ac09-0870070855c9%2Ftypicalmacuser.png?table=test&id=image-block&cache=v2"]]
...
def test_page_is_rewritten_if_not_in_asset_cache (page):
    ...
    assert rewritten["page_cover"] == "https://notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2Fd95897d2-8698-468b-ac09-0870070855c9%2Ftypicalmacuser.png?table=test&id=page-block&cache=v2"
    assert rewritten["page_icon"] == "https://notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2Fd95897d2-8698-468b-ac09-0870070855c9%2Ftypicalmacuser_icon.png?table=test&id=page-block&cache=v2"
