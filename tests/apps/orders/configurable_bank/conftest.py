...
def tinkoff_credit(mocker):
    return mocker.patch("apps.tinkoff.credit.TinkoffCredit.get_initial_payment_url", return_value="https://mocked.link")
...
def _freeze_ue_rate(mocker):
    ...
    mocker.patch("apps.tinkoff.credit.TinkoffCredit.ue", 22)
...
def _freeze_acquiring_percent(mocker):
    ...
    mocker.patch("apps.tinkoff.credit.TinkoffCredit.acquiring_percent", "1.3")
